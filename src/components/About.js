...
const [btn , Btnclr] = useState("Switch Mode")

const [cbtn , csetbtn] = useState("red")
  ...
  return (
    ...
    <div className="container" style={style}>
        <h2 className='container my-2'>About Us</h2>
            ...
            <button className='btn my-3'  style={{backgroundColor:cbtn}} onClick={changecol}>{btn}</button>
            </div>
